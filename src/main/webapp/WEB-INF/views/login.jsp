              ...
              <div class="wow fadeInUp " data-wow-duration="2s" data-wow-delay="0.2s">
                   ...
                   <form name='f' action="/login" method='POST'>
                       ...
                       <div class="form-group">
                           ...
                           <a href="#" class="ForgetPwd pull-right" value="Login" style="color: red">Forget Password?</a>
                       
                      
                          <div>
                          	 <a href="/register" value="Registration" class="white" style="color: blue; margin-left:150px;"> Create User Account </a>
                          </div>
